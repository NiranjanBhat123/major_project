...
class Orders(models.Model):
    ...
    ordered_on = models.DateTimeField(auto_now_add=True, help_text=_("Timestamp of when the order was created"))
    scheduled_on = models.DateTimeField(help_text=_("Scheduled date and time for the service"))
...
class OrderStatusHistory(models.Model):
    ...
    changed_on = models.DateTimeField(auto_now_add=True, help_text=_("Timestamp when the status was changed"))
